...
# Nouns.Build Proposals

Recreating the proposals page of the nouns.build website with hooks. {{ className: 'lead' }}

## Example 
<NounsBuildProposalsHooks />
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center h-screen w-screen bg-gray-100 px-4">
        <div className="grid md:grid-cols-2 gap-6 border rounded shadow-lg bg-white px-6 py-6">
