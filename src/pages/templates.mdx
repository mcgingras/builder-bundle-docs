...
Templates are full page examples of builder bundle. These can be considered "complete" pages utilizing all of the components across the builder bundle stack. Feel free to copy these examples, or use them as inspiration. {{ className: 'lead' }}
